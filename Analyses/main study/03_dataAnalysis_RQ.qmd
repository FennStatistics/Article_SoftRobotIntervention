...
```{r}
head(dat_post_out$participantCAM)
```
...
dat_pre_out$choosen_Robot[dat_pre_out$participantCAM %in% c(ids_SAR_pre, ids_SAR_post)] <- "social assistance robot"
dat_post_out$choosen_Robot[dat_post_out$participantCAM %in% c(ids_SAR_pre, ids_SAR_post)] <- "social assistance robot"
...
dat_pre_out$choosen_Robot[dat_pre_out$participantCAM %in% c(ids_RR_pre, ids_RR_post)] <- "rescue robot"
dat_post_out$choosen_Robot[dat_post_out$participantCAM %in% c(ids_RR_pre, ids_RR_post)] <- "rescue robot"
...
for (c in 1:length(ids_categories)) {
  tmp_pre_SAR <- dat_pre_out[dat_pre_out$category == ids_categories[c] & dat_pre_out$choosen_Robot == "social assistance robot", ]
  tmp_pre_RR <- dat_pre_out[dat_pre_out$category == ids_categories[c] & dat_pre_out$choosen_Robot == "rescue robot", ]
  
  
    tmp_post_SAR <- dat_post_out[dat_post_out$category == ids_categories[c] & dat_post_out$choosen_Robot == "social assistance robot", ]
  tmp_post_RR <- dat_post_out[dat_post_out$category == ids_categories[c] & dat_post_out$choosen_Robot == "rescue robot", ]
  
  

}

# see: https://chatgpt.com/share/6718fc5e-203c-8007-88fb-426c344926b7
