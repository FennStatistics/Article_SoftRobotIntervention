...
# frequencies
tmp <- data.frame(post = networkIndicators_long_within$num_nodes_pos_macro[networkIndicators_long_within$timepoint == "post"], pre = networkIndicators_long_within$num_nodes_pos_macro[networkIndicators_long_within$timepoint == "pre"])
...
# frequencies
tmp <- data.frame(post = networkIndicators_long_within$num_nodes_neg_macro[networkIndicators_long_within$timepoint == "post"], pre = networkIndicators_long_within$num_nodes_neg_macro[networkIndicators_long_within$timepoint == "pre"])
tmp$diff <- tmp$post- tmp$pre
tmp$diff_boolean <- tmp$diff == 0
psych::describe(tmp$diff)
sum(tmp$diff_boolean) / nrow(tmp)
